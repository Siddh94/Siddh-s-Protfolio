        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-400">
              <p>
                I'm a Computer Science Engineering graduate from Chandigarh University (2021-2025) with a CGPA of 7.26, 
                specializing in Deep Learning, NLP, and Recommendation Systems. My passion lies in advancing user engagement 
                models using Large Language Models and contributing to cutting-edge AI research.
              </p>
              <p>
                With hands-on experience in personalized AI models, cloud-based pipelines, and end-to-end ML application deployment, 
                I've developed expertise in building intelligent systems that make a real impact. My research on "Helmet & Number 
                Plate Detection Using YOLOv5" has been published, contributing to traffic safety systems.
              </p>
              <p>
                Beyond academics, I'm an NCC Cadet (Naval Wing), a Gold Medalist in Regional Kabaddi Tournament, and have solved 
                130+ LeetCode problems. I'm actively seeking an AI/ML Engineer role to further advance AI/ML technologies.
              </p>
            </div>
